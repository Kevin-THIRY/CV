                ...
                <slot name="content1">
                  ...
                  <div class="cta26-fragment2">
                    <span class="cta26-text5">
                      Stand out from the crowd with a unique and visually
                      appealing resume that showcases your skills and experience.
                    </span>
                  </div>
                </slot>
              </p>
                ...
                <span>
                  <slot name="action1">
                    ...
                    <div class="cta26-fragment3">
                      <span class="cta26-text6">Get started now</span>
                    </div>
                  </slot>
                </span>
              </button>
