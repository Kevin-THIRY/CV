            ...
            <a :href="link2Url" class="thq-link thq-body-small">
              <slot name="link2">
                ...
                <div class="navbar8-fragment12">
                  <span class="navbar8-text16">#about</span>
                </div>
              </slot>
            </a>
            <a :href="link3Url" class="navbar8-link32 thq-link thq-body-small">
              <slot name="link3">
                ...
                <div class="navbar8-fragment20">
                  <span class="navbar8-text24">#services</span>
                </div>
              </slot>
            </a>
                ...
                <span class="thq-link thq-body-small">
                  <slot name="link4">
                    ...
                    <div class="navbar8-fragment17">
                      <span class="navbar8-text21">#contact</span>
                    </div>
                  </slot>
                </span>
                    ...
                    <div class="navbar8-content3">
                      ...
                      <span class="thq-body-small">
                        <slot name="page3Description">
                          ...
                          <div>
                            <span>
                              Discover the services we offer for creating standout
                              resumes
                            </span>
                          </div>
                        </slot>
              ...
              <span>
                <slot name="action1">
                  ...
                  <div class="navbar8-fragment11">
                    <span class="navbar8-text15">Sign Up</span>
                  </div>
                </slot>
              </span>
            </button>
              ...
              <span>
                <slot name="action2">
                  ...
                  <div class="navbar8-fragment23">
                    <span class="navbar8-text27">Get Started</span>
                  </div>
                </slot>
              </span>
            </button>
                ...
                <span class="navbar8-page32 thq-body-large">
                  <slot name="page3">
                    ...
                    <div class="navbar8-fragment21">
                      <span class="navbar8-text25">Services</span>
                    </div>
                  </slot>
                </span>
                <span class="thq-body-small">
                ...
                <span class="navbar8-page42 thq-body-large">
                  <slot name="page4">
                    ...
                    <div class="navbar8-fragment15">
                      <span class="navbar8-text19">Contact</span>
                    </div>
                  </slot>
                </span>
                <span class="thq-body-small">
...
export default {
  ...
  props: {
    ...
    page1ImageSrc: {
      type: String,
      default:
        'https://images.unsplash.com/photo-1620928572438-075c466c48da?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc1MTYyNjM4NXw&ixlib=rb-4.1.0&q=80&w=1080',
    },
    page2ImageAlt: {
      type: String,
      default: 'About Image',
    ...
    page4ImageSrc: {
      type: String,
      default:
        'https://images.unsplash.com/photo-1684127987312-43455fd95925?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc1MTYyNjM4Nnw&ixlib=rb-4.1.0&q=80&w=1080',
    },
    linkUrlPage3: {
      type: String,
      default: 'https://www.teleporthq.io',
    ...
    page2ImageSrc: {
      type: String,
      default:
        'https://images.unsplash.com/photo-1621388730892-23735656392f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc1MTYyNjM4Nnw&ixlib=rb-4.1.0&q=80&w=1080',
    },
    page3ImageSrc: {
      type: String,
      default:
        'https://images.unsplash.com/photo-1710770563074-6d9cc0d3e338?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc1MTYyNjM4N3w&ixlib=rb-4.1.0&q=80&w=1080',
    },
    link1Url: {
      type: String,
      default: 'https://www.teleporthq.io',
