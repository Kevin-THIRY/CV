          ...
          <slot name="content1">
            ...
            <div class="hero17-fragment4">
              <span class="hero17-text8">
                Stand out from the crowd with a unique and visually appealing CV
                that showcases your skills and experience as a computer engineer.
              </span>
            </div>
          </slot>
        </p>
...
export default {
  ...
  props: {
    image3Src: {
      type: String,
      default:
        'https://images.unsplash.com/photo-1572537996281-a4af8966d964?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc1MTYyNjM4Nnw&ixlib=rb-4.1.0&q=80&w=1080',
    },
    image8Alt: {
      type: String,
      default: 'Dynamic CV Template',
    },
    image2Src: {
      type: String,
      default:
        'https://images.unsplash.com/photo-1536259425322-a7dfc1eac345?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc1MTYyNjM4Nnw&ixlib=rb-4.1.0&q=80&w=1080',
    },
    image6Alt: {
      type: String,
      default: 'Impressive Graphics',
    },
    image11Src: {
      type: String,
      default:
        'https://images.unsplash.com/photo-1617069503577-8a2c30dce408?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc1MTYyNjM4Nnw&ixlib=rb-4.1.0&q=80&w=1080',
    },
    image5Alt: {
      type: String,
    ...
    image1Alt: {
      type: String,
      default: 'Computer Engineer Illustration',
    },
    image7Src: {
      type: String,
      default:
        'https://images.unsplash.com/photo-1613333627123-da097397bcf1?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc1MTYyNjM4Nnw&ixlib=rb-4.1.0&q=80&w=1080',
    },
    image7Alt: {
      type: String,
      default: 'Modern Technology',
    },
    image12Alt: {
      type: String,
      default: 'Personalized Touch',
    },
    image2Alt: {
      type: String,
      default: 'Creative Design Elements',
    },
    image6Src: {
      type: String,
      default:
        'https://images.unsplash.com/photo-1573038950258-62761982b119?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc1MTYyNjM4Nnw&ixlib=rb-4.1.0&q=80&w=1080',
    },
    image12Src: {
      type: String,
      default:
        'https://images.unsplash.com/photo-1611643378160-39d6dd915b69?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc1MTYyNjM4N3w&ixlib=rb-4.1.0&q=80&w=1080',
    },
    image3Alt: {
      type: String,
      default: 'Innovative Animations',
    },
    image9Src: {
      type: String,
      default:
        'https://images.unsplash.com/photo-1620477403960-4188fdd7cee0?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc1MTYyNjM4N3w&ixlib=rb-4.1.0&q=80&w=1080',
    },
    image11Alt: {
      type: String,
      default: 'Eye-catching Details',
    },
    image8Src: {
      type: String,
      default:
        'https://images.unsplash.com/photo-1565350293547-7f5534d7d466?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc1MTYyNjM4N3w&ixlib=rb-4.1.0&q=80&w=1080',
    },
    image5Src: {
      type: String,
      default:
        'https://images.unsplash.com/photo-1732719674511-e94d37e7d1c5?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc1MTYyNjM4N3w&ixlib=rb-4.1.0&q=80&w=1080',
    },
    image4Src: {
      type: String,
      default:
        'https://images.unsplash.com/photo-1743964451957-29592fbe6290?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc1MTYyNjM4N3w&ixlib=rb-4.1.0&q=80&w=1080',
    },
    image10Alt: {
      type: String,
    ...
    image4Alt: {
      type: String,
      default: 'Attractive Visuals',
    },
    image10Src: {
      type: String,
      default:
        'https://images.unsplash.com/photo-1539934293762-22bd4ba34efe?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc1MTYyNjM4N3w&ixlib=rb-4.1.0&q=80&w=1080',
    },
    image9Alt: {
      type: String,
    ...
    image1Src: {
      type: String,
      default:
        'https://images.unsplash.com/photo-1726160423882-7c6cfc1687a4?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc1MTYyNjM4OHw&ixlib=rb-4.1.0&q=80&w=1080',
    },
  },
  components: {
    DangerousHTML,
