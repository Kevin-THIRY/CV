            ...
            <h2 class="thq-heading-2">
              <slot name="feature1Title">
                ...
                <div class="features24-fragment4">
                  <span class="features24-text4">Unique Templates</span>
                </div>
              </slot>
            </h2>
              ...
              <slot name="feature1Description">
                ...
                <div class="features24-fragment5">
                  <span class="features24-text5">
                    Stand out with a visually appealing CV
                  </span>
                </div>
              </slot>
            </span>
            ...
            <h2 class="thq-heading-2">
              <slot name="feature2Title">
                ...
                <div class="features24-fragment6">
                  <span class="features24-text6">Tailored Content</span>
                </div>
              </slot>
            </h2>
            <span class="thq-body-small">
            ...
            <h2 class="thq-heading-2">
              <slot name="feature3Title">
                ...
                <div class="features24-fragment2">
                  <span class="features24-text2">Dynamic Visuals</span>
                </div>
              </slot>
            </h2>
            <span class="thq-body-small">
...
export default {
  ...
  props: {
    ...
    feature3ImgSrc: {
      type: String,
      default:
        'https://images.unsplash.com/photo-1620336655052-b57986f5a26a?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc1MTYyNjM4Nnw&ixlib=rb-4.1.0&q=80&w=1080',
    },
    feature1ImgSrc: {
      type: String,
      default:
        'https://images.unsplash.com/photo-1513619015571-356af6ecebb8?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc1MTYyNjM4Nnw&ixlib=rb-4.1.0&q=80&w=1080',
    },
    feature3ImgAlt: {
      type: String,
    ...
    feature2ImgSrc: {
      type: String,
      default:
        'https://images.unsplash.com/photo-1605099922599-a9e6eaf1ab5e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc1MTYyNjM4Nnw&ixlib=rb-4.1.0&q=80&w=1080',
    },
    feature2ImgAlt: {
      type: String,
